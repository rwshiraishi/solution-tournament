...
- At least one solution must be unconventional: something you would normally self-censor as too weird, too ambitious, or "not what they asked for." Fill this slot with a credible long shot, not a token weird idea — the skeptic's filler verdict will cull an unconventional candidate that exists only to satisfy this quota, which wastes its generation. The test: could this candidate plausibly win at least one rubric dimension outright?
